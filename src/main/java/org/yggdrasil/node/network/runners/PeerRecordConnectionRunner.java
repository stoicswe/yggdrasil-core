...
public class PeerRecordConnectionRunner implements Runnable {
    ...
    public PeerRecordConnectionRunner(NodeConfig nodeConfig, PeerRecordIndexer peerRecordIndexer){
